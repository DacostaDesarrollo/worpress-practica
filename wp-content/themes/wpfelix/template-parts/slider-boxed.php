...
<?php
/**
 * Template part for displaying a full styled Featured Slider.
 *
 * @package WPFelix
 */
...
if ( $squery->have_posts() )
{
    ...
    printf(
        '<div class="grid-container">
            <div class="carousel full-width-banner owl-carousel" data-theme-carousel="true" data-options="%1$s">%2$s</div>
        </div>',
        esc_attr( '{"items":1,"dots":false,"nav":true}' ),
        $output
    );
}
