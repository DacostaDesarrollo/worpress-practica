<?php
/**
 * Popular posts widget. This widget is followed by post view count system.
 *
 * @package WPFelix
 */
...
class WPFelix_Popular_Posts_Widget extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(
            ...
            array(
                'description' => esc_html__( 'Show most viewed posts. Go to Appearance/Customize for configuration.', 'wpfelix' ),
